...
import com.example.elearningar.Vuforia.utils.VideoBackgroundShader;
...
public class SampleAppRenderer {
    ...
    public void render()
    {
        ...
        for (int v = 0; v < viewList.getNumViews(); v++)
        {
            ...
            Matrix34F projMatrix = mRenderingPrimitives.getProjectionMatrix(viewID, COORDINATE_SYSTEM_TYPE.COORDINATE_SYSTEM_CAMERA,null);
