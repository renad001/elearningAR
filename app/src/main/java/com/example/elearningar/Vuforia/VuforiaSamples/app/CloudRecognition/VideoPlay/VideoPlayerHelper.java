...
package com.example.elearningar.Vuforia.VuforiaSamples.app.CloudRecognition.VideoPlay;
    ...
    OnBufferingUpdateListener, OnCompletionListener, OnErrorListener
{
    ...
    {
        Log.d(LOGTAG, "movie loading " + filename);
                ...
                } else
                {
                    try
                    {
                      ...
                      /*  AssetFileDescriptor afd = mParentActivity.getAssets()
                        ...
                        /*Uri videoLink = Uri.parse(filename);*/
